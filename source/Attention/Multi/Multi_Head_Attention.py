...
#    Updated: 2022/10/06 14:31:46 by ebennace         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
from source.Attention.compute_attention.compute import compute_heads_dimensions
from source.Mask.mask import compute_masked_attention, create_mask
from source.Attention.tensor_projection.tensor import duplicate_all_tensor
from source.Attention.compute_attention.compute import compute_attention
from source.Attention.compute_attention.compute import concatenate_attention_heads
from source.Attention.compute_attention.compute import create_multi_heads_attention_model
...
class Multi_Head_Encoder_Attention_Layer(tf.keras.layers.Layer):
